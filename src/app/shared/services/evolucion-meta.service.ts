...
export class EvolucionMetaService {
  ...
  añadir_evolucion(recordID, record) {
    ...
    return this.firestore.doc(
      'Proyectos/' + recordID +'/invitados/KMcN50oZoyDaFIahHHBT/metas_creadas/faltaid').collection('/evolucion/').add(record);
   }
  leer_evolucion(recordID) {
    ...
    return this.firestore.doc(
      'Proyectos/' + recordID + '/invitados/KMcN50oZoyDaFIahHHBT/metas_creadas/faltaid').collection('/evolucion/').snapshotChanges();
   }
  actualizar_evolucion(recordID, record) {
    ...
    this.firestore.doc(
      'Proyectos/MeNzLhC7oCgSMCQ0qjEg/invitados/KMcN50oZoyDaFIahHHBT/metas_creadas/faltaid/evolucion/' + recordID).update(record);
  }
  eliminar_evolucion(record_id) {
     ...
     this.firestore.doc(
       'Proyectos/MeNzLhC7oCgSMCQ0qjEg/invitados/KMcN50oZoyDaFIahHHBT/metas_creadas/faltaid/evolucion/' + record_id).delete();
   }
